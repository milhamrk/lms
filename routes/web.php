...
Route::group(['namespace' => 'Auth', 'middleware' => ['share']], function () {
    ...
    Route::get('/connect-with-google', 'SocialiteController@handleGoogleCallback');
...
Route::group(['namespace' => 'Web', 'middleware' => ['impersonate', 'share']], function () {
    ...
    Route::group(['prefix' => 'course'], function () {
		...
		Route::get('/{slug}/info', 'WebinarController@info');
		Route::get('/info/{id}', 'WebinarController@infoProvinsi');
		Route::post('/{slug}/info', 'FormController@update');

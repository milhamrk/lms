...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>{{ trans('admin/main.certificates') }}</h1>
                                    ...
                                    @foreach($certificates as $certificate)
                                        <tr>
                                            ...
                                            <td class="text-left">
                                                ...
                                                <small class="d-block text-left">{{ $certificate->quiz->webinar->title }})</small>
                                            </td>
                                            ...
                                            <td class="text-center">{{ dateTimeFormat($certificate->created_at, 'j F Y') }}</td>
                                            <td>
                                                <a href="/admin/certificates/{{ $certificate->id }}/download" class="btn-transparent text-primary" data-toggle="tooltip" title="{{ trans('quiz.download_certificate') }}">

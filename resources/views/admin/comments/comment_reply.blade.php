                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @can('admin_'. $itemRelation .'_comments_status')
                                                            <a href="/admin/comments/{{ $page }}/{{ $reply->id }}/toggle" class="btn btn-{{ (($reply->status == 'pending') ? 'success' : 'primary') }} btn-sm">{{ trans('admin/main.'.(($reply->status == 'pending') ? 'publish' : 'pending')) }}</a>
                                                        @endcan

                                                        @can('admin_'. $itemRelation .'_comments_edit')
                                                            <a href="/admin/comments/{{ $page }}/{{ $reply->id }}/edit" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="top" title="{{ trans('admin/main.edit') }}">

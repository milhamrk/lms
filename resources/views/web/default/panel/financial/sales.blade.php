                                ...
                                @foreach($sales as $sale)
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            ...
                                            @else
                                                <span>{{ $currency }}{{ number_format($sale->amount, 2, ".", "")+0 }}</span>
                                            @endif
                                        </td>
                                        <td class="align-middle">{{ $currency }}{{ number_format($sale->discount, 2, ".", "")+0 ?? '0' }}</td>
                                        <td class="align-middle">
                                            @if($sale->payment_method == \App\Models\Sale::$subscribe)
                                                <span class="">{{ trans('financial.subscribe') }}</span>
                                            @else
                                                <span>{{ $currency }}{{ number_format($sale->total_amount, 2, ".", "")+0 }}</span>
                                            @endif
                                        </td>
                                        <td class="align-middle">
                                            <span>{{ $currency }}{{ number_format($sale->getIncomeItem(), 2, ".", "")+0 }}</span>
                                        </td>
                                        <td class="align-middle">
                                            @switch($sale->type)

                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center align-middle">
                                            @switch($accounting->type)
                                                ...
                                                <span class="font-16 font-weight-bold text-primary">+{{ number_format($accounting->amount, 2, ".", "")+0 }}</span>
                                                @break;
                                                @case(\App\Models\Accounting::$deduction)
                                                <span class="font-16 font-weight-bold text-danger">-{{ number_format($accounting->amount, 2, ".", "")+0 }}</span>
                                                @break;
                                            @endswitch
                                        </td>
